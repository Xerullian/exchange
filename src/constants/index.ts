...
const BURN1_ADDRESS = '0x31A9042dCE0C13975D04d0E9758Cb7B596F0dD43'
export const BURN1COIN: { [chainId in ChainId]: Token } = {
    [ChainId.MAINNET]: new Token(ChainId.MAINNET, BURN1_ADDRESS, 9, 'BURN1COIN', 'Burn1Coin'),
    [ChainId.BSCTESTNET]: new Token(ChainId.BSCTESTNET, '0x0000000000000000000000000000000000000000', 9, 'BURN1COIN', 'Burn1Coin')
}
...
export const INITIAL_ALLOWED_SLIPPAGE = 1300
